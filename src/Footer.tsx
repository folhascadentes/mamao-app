      ...
      >
        ...
        >
          ...
          >
            ...
            <section>
              Olá! Somos a Associação de Inovação em Acessibilidade
              Computacional (AIAC), também conhecida como Folhas Cadentes.
              Estamos fazendo um projeto para ajudar pessoas que usam a língua
              de sinais. Para isso, estamos pedindo que as pessoas nos enviem
              vídeos fazendo sinais. Nesta página, vamos explicar como usamos os
              vídeos e outras informações que você nos dá. Ao usar nosso
              aplicativo, você está concordando com o que explicamos aqui.
            </section>
            ...
            <section>
              Nós coletamos vídeos que você nos manda através do nosso
              aplicativo. Também pedimos algumas informações sobre você, como
              sua idade, gênero, cor da pele e onde você vive. Isso ajuda a
              gente a entender melhor quem está usando a língua de sinais.
            </section>
            <h2>
            ...
            <section>
              ...
              <ol className="list-decimal ml-4 mt-2">
                ...
                <li>
                  ...
                  compreendendo diferentes tipos de pessoas. Você pode saber
                  mais sobre porque precisamos de dados diversificados acessando
                  a página{" "}
                  <a
                    className="hover:text-indigo-600 text-indigo-500 font-bold"
                    href="/database-diversity-importance"
                  >
                    Por que precisamos de diferentes tipos de dados para fazer
                    um bom tradutor de Língua de Sinais
                  </a>
                </li>
                <li>
            ...
            <section>
              Nós não damos suas informações para outras pessoas, a menos que
              você nos permita ou que a lei nos obrigue. Mas vamos permitir que
              outras pessoas baixem os vídeos. Quem baixar os vídeos terá que
              assinar um termo de compromisso que vai usar os vídeos de maneira
              correta, porém ao usar o aplicativo você concorda em compartilhar
              os vídeos com outras pessoas.
            </section>
            <h2>
              <b>4. Segurança</b>
            </h2>
            ...
            <section>
              ...
              que usar nosso aplicativo de maneira correta e legal. Não pode
              usar o aplicativo para fazer coisas ruins ou ilegais.
            </section>
            <h2>
              <b>2. Vídeos e Informações</b>
            </h2>
            <section>
              Quando você manda um vídeo ou dá uma informação para nós, você
              está nos dando permissão para usar o vídeo ou a informação da
              maneira que explicamos na nossa Política de Privacidade. Você está
              nos garantindo que tem o direito de dar essa permissão.
            </section>
            <h2>
            ...
            <section>
              ...
              correta e legal. Você não pode compartilhar o vídeo sem a
              permissão da pessoa que está no vídeo. E você tem que concordar em
              apagar o vídeo se a pessoa que está no vídeo pedir.
            </section>
            <h2>
            ...
            <section>
              ...
              perfeitamente. E não somos responsáveis se algo der errado
              enquanto você está usando o aplicativo.
            </section>
            <h2>
              <b>5. Mudanças nos Termos de Uso</b>
            </h2>
            <section>
              De vez em quando, podemos mudar estes Termos de Uso. Se fizermos
              uma grande mudança, vamos te avisar por e-mail ou no nosso
              aplicativo. Se você continuar usando o aplicativo depois de uma
              mudança, isso significa que você concorda com a mudança.
            </section>
            <section>
              Lembre-se: ao usar nosso aplicativo, você está concordando com
              estes Termos de Uso. Então, por favor, leia-os com atenção. E se
              você tiver alguma pergunta, por favor, nos mande uma mensagem.
