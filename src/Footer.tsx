          ...
          <ModalContent borderRadius="1rem" css={{ backgroundColor }}>
            ...
            >
              ...
              <section>
                ...
                nosso aplicativo, onde coletamos vídeos de usuários para um
                banco de dados público de linguagem de sinais. Por favor, leia
                estes Termos de Privacidade cuidadosamente. Ao utilizar o nosso
              ...
              <section>
                ...
                <ol className="list-decimal ml-4 mt-2">
                  <li>
                    Para fornecer, manter e melhorar nossa aplicação web.{" "}
                  </li>
                  <li>
                  ...
                  <li>
                    Para garantir que a base de dados coletada seja
                    diversificada, compreendendo diferentes tipos de pessoas.{" "}
                  </li>
                  <li>
                    Para comunicar-se com você sobre atualizações da aplicação
                    web e outros assuntos de interesse do usuário.
                  </li>
                </ol>
              </section>
              <h2>
              ...
              <section>
                ...
                qualquer lei, regulamento ou solicitação legal. Os dados
                coletados poderão ser baixados em duas formas: Dados de marco de
                estimativa de pose dos vídeos coletados, que garantem maior
                privacidade; e dados dos vídeos, nesse caso, quem baixar terá
                que assinar um termo de responsabilidade se comprometendo a não
                compartilhar publicamente esses dados sem autorização prévia da
                pessoa em questão.
              </section>
              <h2>
                <b>4. Segurança</b>
              ...
              <section>
                Você tem o direito de acessar, atualizar, corrigir e excluir
                suas informações a qualquer momento. Se você deseja exercer esse
                direito, entre em contato conosco através das informações de
                contato fornecidas abaixo. As pessoas que baixaram os vídeos
                serão notificadas para excluírem também, porém não temos como
                garantir que o façam.
              </section>
              <h2>
              ...
              <section>
                ...
                Se fizermos alterações que modifiquem substancialmente a forma
                como usamos suas informações pessoais, iremos notificá-lo por
                e-mail ou através de um aviso na aplicação web.
              </section>
            </ModalBody>
          </ModalContent>
        </Modal>
