    ...
    <div className="flex flex-wrap justify-center space-x-8 xl:space-x-16 mt-8 xl:mt-16 mb-24">
      ...
      >
        ...
        <p>
          ...
          Juntos, estamos trabalhando para tornar o desejo de uma internet mais
          acessível uma realidade.
        </p>
        <p>
        ...
        <p>
          Queremos criar um mundo mais igualitário, onde todos tenham as mesmas
          oportunidades. Acreditamos que todos nós, em algum momento, podemos
          enfrentar dificuldades ou limitações, e é por isso que estamos
          trabalhando para tornar a internet mais acessível.
        </p>
        <p>
        ...
        <p>
          Estamos criando um tradutor de língua de sinais que será gratuito para
          todos. Este projeto se chama Mamão e tem como objetivo tornar a
      ...
      <div className="hidden md:flex md:flex-col space-y-6">
        <img src={handsTwo} style={{ height: "685px" }} alt="" />
        <img src={handsOne} style={{ height: "685px" }} alt="" />
      </div>
    </div>
  );
}
